package com.lagab.capoeira.capoeiraportal.security.jwt;

import com.lagab.capoeira.capoeiraportal.config.ApplicationProperties;
...
public class JWTFilterTest {
    ...
    public void testJWTFilter() throws Exception {
        UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(
            "test-user",
            "test-password",
            Collections.singletonList(new SimpleGrantedAuthority(Authorities.USER))
        );
