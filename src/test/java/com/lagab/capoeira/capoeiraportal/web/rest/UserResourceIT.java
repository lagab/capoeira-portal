...
import com.lagab.capoeira.capoeiraportal.service.mapper.UserMapper;
...
public class UserResourceIT {
    ...
    public void createUser() throws Exception {
        ...
        managedUserVM.setAuthorities(Collections.singleton(Authorities.USER));
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
                ...
                .andExpect(jsonPath("$").value(hasItems(Authorities.USER, Authorities.ADMIN)));
    }
    ...
    public void testUserDTOtoUser() {
        ...
        userDTO.setAuthorities(Collections.singleton(Authorities.USER));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(Authorities.USER);
    }
    ...
    public void testUserToUserDTO() {
        ...
        authority.setName(Authorities.USER);
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(Authorities.USER);
    ...
    public void testAuthorityEquals() {
        ...
        authorityB.setName(Authorities.ADMIN);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityA.setName(Authorities.USER);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(Authorities.USER);
        assertThat(authorityA).isEqualTo(authorityB);
