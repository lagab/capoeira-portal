...
import com.lagab.capoeira.capoeiraportal.repository.AuthorityRepository;
...
public class AccountResourceIT {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restAccountMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.authorities").value(Authorities.ADMIN));
    }
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(Authorities.USER));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(Authorities.USER));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(Authorities.USER));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(Authorities.ADMIN));
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(Authorities.USER).get());
    }
    ...
    public void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(Authorities.ADMIN));
